/*
Copyright 2019 The Giant Swarm authors.
...
// +kubebuilder:rbac:groups=ship.giantwarm.io,resources=frigates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ship.giantwarm.io,resources=frigates/status,verbs=get;update;patch
